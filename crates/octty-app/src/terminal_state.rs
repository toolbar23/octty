...
pub(crate) struct OcttyApp {
    ...
    pub(crate) workspace_watch_tx: mpsc::UnboundedSender<String>,
    pub(crate) workspace_watch_rx: Option<mpsc::UnboundedReceiver<String>>,
    pub(crate) workspace_watch_notifications_active: bool,
    ...
    pub(crate) inner_session_resume_dialog: Option<InnerSessionResumeDialog>,
    pub(crate) codex_inner_session_scan_active: bool,
    pub(crate) codex_inner_session_scan_attempts: HashMap<String, u8>,
